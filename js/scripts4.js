...
function initHeader() {
 ...
 if (window_width > 1025){
        ...
        largeHeader = document.getElementById('line5-container');
        //largeHeader.style.height = height+'px';

        canvas = document.getElementById('line5-canvas');
        canvas.width = width;
    ...
    function mouseMove1(e) {
        ...
        var this_offset = $('#line5-canvas').offset();
        target.x = posx;
 ...
 $(window).load(function() {
        width = $('#line5-container').width();
        height = $('#line5-container').height();
