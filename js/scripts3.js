...
function initHeader() {
 ...
 if (window_width > 1025){
        ...
        largeHeader = document.getElementById('line4-container');
        //largeHeader.style.height = height+'px';

        canvas = document.getElementById('line4-canvas');
        canvas.width = width;
    ...
    function mouseMove1(e) {
        ...
        var this_offset = $('#line4-canvas').offset();
        target.x = posx;
        target.y = posy - this_offset.top;
    }

    function scrollCheck() {
       if(document.body.scrollTop > height+100000) animateHeader = false;
 ...
 $(window).load(function() {
        width = $('#line4-container').width();
        height = $('#line4-container').height();
