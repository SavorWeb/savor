...
`id` int(11) NOT NULL,
  ...
  `field_rotatorLine1` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `field_rotatorLine2` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `field_rotatorLine3` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
